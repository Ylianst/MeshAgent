...
void ILibDuktape_Polyfills_JS_Init(duk_context *ctx)
{
	...
	ILibDuktape_AddCompressedModuleEx(ctx, "service-manager", _servicemanager, "2023-01-20T13:07:47.000-08:00");
